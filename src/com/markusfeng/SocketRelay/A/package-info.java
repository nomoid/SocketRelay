 ...
 * SocketHandler. Note that this package also depends on the L package,
 * as the SocketServer implements SocketListenerHandler to enable
 * handling of SocketListeners.
 *
 * @author Markus Feng
 */
